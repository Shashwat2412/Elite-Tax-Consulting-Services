...
import { ArrowLeft, Truck, Shield, FileCheck, Users, CheckCircle, Clock, Award, Phone, Mail, MessageCircle, MapPin, Zap } from 'lucide-react'
...
export default function TruckingServicesPage() {
  const truckingServices = [
    {
      title: "MC & DOT Number Registration",
      description:
        "Complete Motor Carrier (MC) and Department of Transportation (DOT) number registration services for your trucking business.",
      features: [
        "Motor Carrier (MC) number application",
        "USDOT number registration",
        "Operating authority filing",
        "Interstate commerce registration",
    ...
    },
    {
      ...
      description:
        "Comprehensive permit and licensing services to ensure your trucking operation is fully compliant and legal.",
      features: [
    ...
    },
    {
      ...
      description:
        "Ensure your trucking business meets all safety regulations and compliance requirements for smooth operations.",
      features: [
    ...
    },
    {
      ...
      description:
        "Specialized business formation services tailoblue specifically for trucking companies and owner-operators.",
      features: [
  ...
  const benefits = [
    {
      ...
      description: "Specialized knowledge of trucking industry regulations and requirements",
    },
    {
      icon: <Clock className="h-6 w-6" />,
      title: "Fast Processing",
      description: "Quick turnaround times to get your trucks on the road faster",
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: "Full Compliance",
      description: "Ensure complete compliance with DOT and FMCSA regulations",
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "Industry Experience",
      description: "Years of experience serving trucking companies nationwide",
    },
  ]
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-12 animate-fade-in">
            <Badge className="bg-blue-100 text-blue-800 mb-4">Trucking Compliance & Setup</Badge>
            <h1 className="text-4xl md:text-5xl font-bold text-navy-900 mb-6">
              <span className="text-blue-600">Trucking Compliance</span> & Business Setup
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Complete trucking business setup and compliance services. From MC & DOT numbers to safety compliance,
              we handle all aspects of getting your trucking operation road-ready and legally compliant.
            </p>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    <Button
                      onClick={() => {
                        ...
                        const message = "Hi! I'm interested in your trucking compliance and setup services. Can you help me?"
      ...
      <section className="py-16 bg-gradient-to-r from-navy-900 to-blue-800 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose Our Trucking Services?</h2>
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Specialized expertise in trucking industry compliance and business formation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "DOT/FMCSA Expertise",
                description:
                  "Deep understanding of Department of Transportation and FMCSA regulations and requirements.",
                icon: <Truck className="h-8 w-8" />,
              },
              {
                title: "Complete Compliance",
                description:
                  "Ensure your trucking business meets all federal and state compliance requirements.",
                icon: <Shield className="h-8 w-8" />,
              },
              {
                title: "Industry Focus",
                description:
                  "Specialized services designed specifically for trucking companies and owner-operators.",
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-navy-900 mb-6">
              Ready to Get Your Trucks on the Road?
            </h2>
            <p className="text-xl text-gray-600 mb-8">
              Don't let compliance issues delay your trucking business. Our experts will get you road-ready with all
              necessary permits, licenses, and registrations.
            </p>
